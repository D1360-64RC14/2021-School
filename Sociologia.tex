...
\begin{document}
    ...
    \begin{day}{14/05/2021}
        \begin{enumerate}
            \item[1.] Qual foi o contexto de surgimento do Estado Neoliberal? Escreva um parágrafo em seu caderno.
            \response{Sua resposta deve considerar contexto mundial do capitalismo na década de 1980, marcado pela crise do Estado de Bem-Estar Social e pelo questionamento da intervenção do Estado sobre a Economia. Você deve abordar a experiência dos governos de Tatcher e Reagan.}
            
            \item[2.] Explique as principais características do Estado Neoliberal e os contrapontos estabelecidos em relação a este sistema. Escreva um parágrafo em seu caderno.
            \response{Sua resposta deve considerar características do neoliberalismo, como a flexibilização das leis trabalhistas, a desregulamentação da economia, a diminuição dos gastos públicos, o Estado mínimo e o livre mercado. Cite os contrapontos ao modelo neoliberal, empreendidos principalmente a partir da Crise de 2008, que exigiu a intervenção do Estado na economia.}
        \end{enumerate}
    \end{day}
