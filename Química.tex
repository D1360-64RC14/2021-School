...
\begin{document}
    ...
    \begin{day}{13/05/2021}
        ...
        \chemfig[atom sep=30pt]{O(-[:90] C(-[:-180] C) =[:90] O) - C - C - C - C - C - C - C - C}
    ...
    \begin{day}{2º Trimestre --- 27/05/2021}
        ...
        Apresenta hidroxila \chemfig[atom sep=30pt]{-OH} ligada a carbono saturado. \textit{(carbono saturado é aquele que faz apenas ligações simples)}
    ...
    \begin{day}{22/07/2021}
        ...
        \begin{center}
            \chemfig{\colorx{green}{C}([:90]=O)([:-45]-CH_2-[:45]CH_3)([:225]-CH_2-[:135]CH_3)}
        \end{center}
        ...
        \begin{center}
            \chemfig{[:90]O=C([:45]-C([:-45]-H)([:45]-H)([:120]-H))([:135]-C([:225]-H)([:60]-H)([:135]-H))}
        ...
        \vspace{12pt}
        \noindent 1) \chemfig{O=C([:45]-CH_2-[:0]CH_3)([:-45]-CH_2-[:0]CH_3)}
        
        \noindent 2) \chemfig{O=C([:45]-CH_2-[:0]CH_2-[:0]CH_3)([:-45]-CH_3)}
    ...
    \begin{day}{29/07/2021}
        \title 3 {Funções Químicas Oxigenadas -- Ácidos Carboxílicos}
        
        Os ácidos carboxílicos são compostos caracterizados pela presença do grupo carboxila.
        
        \title 5 {Grupo funcional}
        
        \begin{center}
            \chemfig[atom sep=30pt]{\textbf{R} - C([:-45]=O)([:45]-OH)}
        \end{center}
        
        \title{4}{Nomeclatura do Ácido Carboxílico}
        ...
        \begin{center}
            \begin{tabular}{|c|c|c|}
                ...
                \textbf{PREFIXO} & \textbf{INTERMEDIÁRIO} & \textbf{SUFIXO} \\
                \hline
                \colorx{red}{Número de Carbonos} & \colorx{green}{Ligação} & \colorx{blue}{Função -- OICO} \\
                \hline
            \end{tabular}
            \vspace{8pt}
            
            \chemfig[atom sep=30pt]{H - C([:45]=O)([:-45]-OH)}
        \end{center}
        
        \title 3 {Atividade}
        
        Dê o nome aos seguintes ácidos carboxílicos:
        
        \begin{center}
            \chemfig[atom sep=30pt]{()-[:45]()([:90]-())-[:-45]()-[:45]()([:90]=O)-[:-45]OH}
        
            \vspace{8pt}
            \begin{tabular}{r c l}
                Carbono 3              &=& radical METIL \\
                4 carbonos             &=& BUT           \\
                Ligação entre carbonos &=& AN            \\
                Ácido carboxílico      &=& OICO          \\
                \hline
                Resultado              &=& ÁCIDO 3-METIL-BUTANOICO
            \end{tabular}
            \vspace{12pt}
            
            \chemfig[atom sep=30pt]{()-[:45]()-[:-45]()-[:45]()([:90]-())-()([:90]=O)-[:-45]OH}
            
            \vspace{8pt}
            \begin{tabular}{r c l}
                Carbono 2              &=& radical METIL \\
                5 carbonos             &=& PENT          \\
                Ligação entre carbonos &=& AN            \\
                Ácido carboxílico      &=& OICO          \\
                \hline
                Resultado              &=& ÁCIDO 2-METIL-PENTANOICO
            \end{tabular}
        \end{center}
        
        Os quatro ácidos carboxílicos mais simples apresentam nomes usuais formados pelos prefixos: form, acet, propion, butir, seguidos da palavra ico.
        
        \begin{center}
            \chemfig[atom sep=30pt]{H-C([:45]=O)([:-45]-OH)} ÁCIDO METANOICO - ÁCIDO FÓRMICO
            
            \chemfig[atom sep=30pt]{H-C([:90]-H)([:-90]-H)-C([:45]=O)([:-45]-OH)} ÁCIDO ETANOICO - ÁCIDO ACÉTICO
            
            \chemfig[atom sep=30pt]{H-C([:90]-H)([:-90]-H)-C([:90]-H)([:-90]-H)-C([:45]=O)([:-45]-OH)} ÁCIDO PROPANOICO - ÁCIDO PROPIÔNICO
            
            \chemfig[atom sep=30pt]{H-C([:90]-H)([:-90]-H)-C([:90]-H)([:-90]-H)-C([:90]-H)([:-90]-H)-C([:45]=O)([:-45]-OH)} ÁCIDO BUTANOICO - ÁCIDO BUTÍRICO
        \end{center}

        \title 3 {Funções Químicas Oxigenadas: Éster}
        
        Simplificadamente poemos considerar uqe os ésteres se originam a partir da substituição do hidrogênio do grupo OH de um ácido carboxílico por um radical orgânico (R ou Ar [Aromatico])
        
        \begin{center}
            \chemfig[atom sep=30pt]{\textbf{R} - C([:90]=O) - O - \textbf{R}} \hspace{2cm} \chemfig[atom sep=30pt]{\textbf{R} - C([:90]=O) - O - \textbf{Ar}}
        \end{center}
    \end{day}
    ...
    \begin{day}{05/08/2021}
        \begin{tabular}{|c|c|c|c|c|c|}
            ...
            \colorx{purple}{Ligação} &
            \colorx{green}{OATO} &
            DE &
            \colorx{red}{Nome do Radical} &
            A \\
            \hline
        \end{tabular}
        
        \begin{center}
            \chemfig{\textbf{R} - C([:90]=O) - O - \textbf{R'}} \hspace{1cm}
            \chemfig{\textbf{HC} - C([:90]=O) - O - \textbf{CH_3}}
            
            \textbf{\colorx{blue}{MET}\colorx{purple}{AN}\colorx{green}{OATO} DE \colorx{red}{METIL}A}
        \end{center}
