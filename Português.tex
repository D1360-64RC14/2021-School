...
\begin{document}
    ...
    \begin{day}{02/07/2021}
        \title 3 {Tipos de argumentos}
        
        \begin{itemize}
            \item Argumento de autoridade
            \item Argumento por evidência
            \item Argumento de comparação
            \item Argumento por exemplificação
            \item Argumento de princípio
            \item Argumento de causa e consequência
            \item Argumento estatístico
        \end{itemize}
    \end{day}
    
    \begin{day}{08/07/2021}
        \title 3 {Resenha vs Resumo: Uma das partes da resenha é o resumo, mas a resenha não é um resumo}
        
        \textbf{Resumo} é retirado de um texto original com apenas as informações mais relevantes, não se pode acrescentar nada que já não existia no primeiro texto.
        
        \textbf{Resenha} mescla resumo, acrescenta informações novas ao texto. Em toda resenha existe um resumo.
        
        \begin{itemize}
            \item\textbf{Resenha Descritiva}: não há espaço para opinião do autor.
            \item\textbf{Resenha Crítica ou Opinativa}: há espaço para que o autor apresente teses sobre o tema abordado, sendo, então, um texto de natureza informativo-argumentativo.
        \end{itemize}
    \end{day}
    ...
    \begin{day}{22/07/2021}
        ...
        \begin{itemize}[nosep]
            \item Entender a proposta
            \item Escrever sobre a proposta
            \item Ortografia
            \item Conteúdo
            \item Proposta de intervenção
        \end{itemize}
        
        \title 3 {Dissertação Argumentativa}
        
        \begin{itemize}[nosep]
            \item Ler os textos motivadores.
            \item Nº Parágrafos: Introdução (1); Desenvolvimento (2); Conclusão (1).
            \item Impessoalidade.
            \item \underline{Não usar}: \emph{"eu acho"}; \emph{"na minha opinião"}; \emph{"do meu ponto de vista"}. \underline{Ao invés, usar}: \emph{"é bom lembrar"}, \emph{"é preciso considerar"}, \emph{"é importante"}, \emph{"convém observar"}.
        \end{itemize}
        \vspace{8pt}
        
        \begin{tabular}{l p{12cm}}
            \textbf{Introdução}:      & apresentar o tema de forma elaborada e criativa. \\
            \textbf{Desenvolvimento}: & traga o seu ponto de vista (pensando na conclusão); argumentar problemas. \\
            \textbf{Conclusão}:       & proposta de intervenção. Intervir no problema colocado. Não é o momento de levantar questionamentos.
        \end{tabular}
    \end{day}
    
    \begin{day}{23/07/2021}
        \title 3 {Exemplo de proposta de intervenção}
        
        Método \emph{"Dois agentes"}: "... o estado e a sociedade tem que tomar uma postura..."
    \end{day}
\end{document}
