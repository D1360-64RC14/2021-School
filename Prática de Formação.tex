...
\begin{document}
    ...
    \begin{day}{22/06/2021}
        \title 2 {Rotinas na Educação Infantil: a organização do trabalho pedagógico.}
        ...
        \begin{itemize}[nosep]
            \item Tempo;
            \item Espaço;
            \item Concepções pedagógicas;
            \item Organização do professor;
            \item Organização das crianças;
            \item Controle sobre as crianças;
            \item Conceito de criança e infância;
            \item Conceito de escola;
            \item Autonomia;
            \item ...
        \end{itemize}
        
        \title 3 {Organização do Dia}
        
           v-------- Criança Criativa --------v
        Momentos Optativos  |\
        I> Momentos Livres  | > Liberdade --- Limites
        Momentos Conduzidos |/     ^-------------|
        
        São categorias que proporcionam a liberdade de ação para criança a partir do conhecimento de seus limites.
        
        \vspace{6pt}
        \begin{itemize}[nosep]
            \item Desafiador -- um pouco além do que dominam
            \item Que ofereça experiências de explorações, aventuras
            \item Crie bem-estar, confiança, relacionamento e aprendizagem
            \item Modiliário e equipamento móvel
            \item Ambiente natural de fácil acesso e rico em elementos
            \item Utiliza paredes, teto e chão
            \item Construir cantos temáticos e esconderijos
            \item Parecido e diferente ao da casa
            \item Oportunizar o trabalho em pequenos grupos
        \end{itemize}
        \vspace{6pt}
        
        A rotina da como categoria pedagógica:
        
        \vspace{6pt}
        \begin{itemize}[nosep]
            \item A organização do ambiente;
            \item Os usos do tempo;
            \item A seleção e os usos dos materiais;
            \item A seleção e a proposição das atividades. 
        \end{itemize}
        
        \title 3 {Vídeo: D4 -- Música na Educação Infantil. 0 a 5 Anos}
    \end{day}
    
    \begin{day}{03/08/2021}
        Pré-escola - Linhas do Conhecimento
        Pré-escola - proposta 08
    \end{day}
\end{document}
