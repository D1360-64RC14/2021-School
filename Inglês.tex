    ...
    \begin{day}{28/04/2021}
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}[nosep]
                \item[a)] He \underline{\bf worked} here for three months. (work)
                \item[b)] They \underline{\bf *****} to Australia many times. (go)
                \item[c)] \underline{\bf Have} you ever \underline{\bf went} to Paris? (be)
                \item[d)] My family \underline{\bf *****} me recently. (visit)
                \item[e)] My parents \underline{\bf don't arribed} yet. (not arrive)
            \end{enumerate}
        \end{enumerate}
    \end{day}
